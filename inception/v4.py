...
class InceptionB(nn.Module):
    def __init__(self, in_channels: int):
        ...
        self.b3 = nn.Sequential(
            ...
            ConvBNReLU(
                in_channels=192, out_channels=224, kernel_size=(7, 1), padding=(3, 0)
            ),
            ConvBNReLU(
                in_channels=224, out_channels=256, kernel_size=(1, 7), padding=(0, 3)
            ),
        )
        self.b4 = nn.Sequential(
            ConvBNReLU(in_channels=in_channels, out_channels=192, kernel_size=1),
            ...
            ConvBNReLU(
                in_channels=224, out_channels=224, kernel_size=(1, 7), padding=(0, 3)
            ),
            ConvBNReLU(
                in_channels=224, out_channels=256, kernel_size=(7, 1), padding=(3, 0)
            ),
        )
...
class InceptionC(nn.Module):
    def __init__(self, in_channels: int):
        ...
        self.b3_a = ConvBNReLU(
            in_channels=384, out_channels=256, kernel_size=(1, 3), padding=(0, 1)
        )
        self.b3_b = ConvBNReLU(
            in_channels=384, out_channels=256, kernel_size=(3, 1), padding=(1, 0)
        )

        self.b4_1 = nn.Sequential(
            ConvBNReLU(in_channels=in_channels, out_channels=384, kernel_size=1),
            ConvBNReLU(
                in_channels=384, out_channels=448, kernel_size=(1, 3), padding=(0, 1)
            ),
            ConvBNReLU(
                in_channels=448, out_channels=512, kernel_size=(3, 1), padding=(1, 0)
            ),
        )
        self.b4_a = ConvBNReLU(
            in_channels=512, out_channels=256, kernel_size=(3, 1), padding=(1, 0)
        )
        self.b4_b = ConvBNReLU(
            in_channels=512, out_channels=256, kernel_size=(1, 3), padding=(0, 1)
        )
...
class ReductionB(nn.Module):
    def __init__(self, in_channels: int):
        ...
        self.b3 = nn.Sequential(
            ConvBNReLU(in_channels=in_channels, out_channels=256, kernel_size=1),
            ConvBNReLU(
                in_channels=256, out_channels=256, kernel_size=(1, 7), padding=(0, 3)
            ),
            ConvBNReLU(
                in_channels=256, out_channels=320, kernel_size=(7, 1), padding=(3, 0)
            ),
...
class Stem(nn.Module):
    def __init__(self, in_channels: int):
        ...
        self.brancha_2 = ConvBNReLU(
            in_channels=64, out_channels=96, kernel_size=3, stride=2
        )
        ...
        self.branchb_2 = nn.Sequential(
            ConvBNReLU(in_channels=160, out_channels=64, kernel_size=1),
            ConvBNReLU(
                in_channels=64, out_channels=64, kernel_size=(7, 1), padding=(3, 0)
            ),
            ConvBNReLU(
                in_channels=64, out_channels=64, kernel_size=(1, 7), padding=(0, 3)
            ),
