...
train_dataset = VOCDataset(root="data", year="2007", image_set="train", download=True, transform=train_transform)
...
test_dataset = VOCDataset(root="data", year="2007", image_set="val", download=True, transform=test_transform)
...
for epoch in range(EPOCHS):
    ...
    for i, (img, targets) in loop:
        ...
        loop.set_description(f"epoch: {epoch + 1}/{EPOCHS} | batch: {i + 1}/{len(train_loader)}")
